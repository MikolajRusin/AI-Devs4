  ...
  json_schema:
    ...
    schema:
      ...
      properties:
        tagged_jobs:
          type: "object"
          description: "A dictionary where keys are job_ids and values are arrays of tag_ids, use mixed tag_ids if the job description is related wit more than one tag."
